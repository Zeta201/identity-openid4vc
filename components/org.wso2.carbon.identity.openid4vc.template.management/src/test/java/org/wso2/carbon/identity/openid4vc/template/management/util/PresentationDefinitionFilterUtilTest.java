...
public class PresentationDefinitionFilterUtilTest {
    ...
    public void testGetFilterQueryBuilderWithEqOperationBuildsEqualityClause() throws Exception {
        ...
        // Set up — parse a displayName eq filter
        List<ExpressionNode> nodes =
                PresentationDefinitionFilterUtil.getExpressionNodes("displayName eq \"testName\"");
        ...
        Assert.assertTrue(builder.getFilterQuery().contains("DISPLAY_NAME = ?"),
                "Expected 'DISPLAY_NAME = ?' in SQL clause for eq operation, got: " + builder.getFilterQuery());
    ...
    public void testGetFilterQueryBuilderWithSwOperationBuildsStartsWithLikeClause() throws Exception {
        ...
        // Set up — parse a displayName sw filter
        List<ExpressionNode> nodes =
                PresentationDefinitionFilterUtil.getExpressionNodes("displayName sw \"prefix\"");
        ...
        Assert.assertTrue(builder.getFilterQuery().contains("DISPLAY_NAME LIKE ?"),
                "Expected 'DISPLAY_NAME LIKE ?' in SQL clause for sw operation");
    ...
    public void testGetFilterQueryBuilderWithEwOperationBuildsEndsWithLikeClause() throws Exception {
        ...
        // Set up — parse a displayName ew filter
        List<ExpressionNode> nodes =
                PresentationDefinitionFilterUtil.getExpressionNodes("displayName ew \"suffix\"");
        ...
        Assert.assertTrue(builder.getFilterQuery().contains("DISPLAY_NAME LIKE ?"),
                "Expected 'DISPLAY_NAME LIKE ?' in SQL clause for ew operation");
