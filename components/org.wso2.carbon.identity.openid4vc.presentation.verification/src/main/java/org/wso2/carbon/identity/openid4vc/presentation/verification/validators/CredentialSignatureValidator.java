...
public interface CredentialSignatureValidator {
     ...
     * @param requestedCredential       the credential entry from the presentation definition carrying
     *                                  key-resolution config (JWKS URI, PEM, trusted CAs, etc.)
     * @throws VerificationException if key resolution or signature verification fails
     */
    void validateSignature(String issuerJwt, RequestedCredential requestedCredential) throws VerificationException;
}
