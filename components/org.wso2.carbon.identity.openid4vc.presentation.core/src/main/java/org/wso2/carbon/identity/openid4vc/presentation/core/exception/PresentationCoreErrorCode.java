...
public enum PresentationCoreErrorCode {
    ...
    ORG_TENANT_RESOLUTION_ERROR("VPC-65013", "server_error",
            "Organization tenant resolution error.",
            "An error occurred while resolving the tenant domain for organization '%s'.");
