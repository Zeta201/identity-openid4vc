...
public interface PresentationSessionService {
     ...
     */
    void handleSessionVerified(String requestId, String tenantDomain, VerificationResponseDTO verificationResponse)
            throws PresentationCoreException;
     ...
     */
    void handleSessionFailed(String requestId, String tenantDomain, String errorType, String errorDescription)
            throws PresentationCoreException;
     ...
     */
    VPSessionStatusRespDTO getVerificationSessionStatus(String requestId, String tenantDomain)
            throws PresentationCoreException;
     ...
     * @throws PresentationCoreException if the session lookup fails
     */
    VPVerificationResultDTO getPresentationSessionResult(String requestId, String tenantDomain)
            throws PresentationCoreException;
