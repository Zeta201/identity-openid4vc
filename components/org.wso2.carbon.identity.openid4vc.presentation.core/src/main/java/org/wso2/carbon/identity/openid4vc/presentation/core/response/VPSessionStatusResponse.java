 ...
 */
public class VPSessionStatusResponse {

    private static final Gson GSON = new Gson();
    private final Map<String, Object> payload;

    private VPSessionStatusResponse(Map<String, Object> payload) {
    ...
    /**
     * Builder for {@link VPSessionStatusResponse}.
     */
    public static class Builder {
        ...
        public VPSessionStatusResponse build() {

            return new VPSessionStatusResponse(payload);
        }
    }
}
